            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-md border border-gray-100">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Or{" "}
                        <Link to="/login" className="font-medium text-[#2F9E44] hover:text-[#238035]">
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div>
                            <input
                                type="email"
                                required
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#2F9E44] focus:border-[#2F9E44] focus:z-10 sm:text-sm"
                    ...
                    <div>
                        ...
                        >
                            <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                <UserPlus className="h-5 w-5 text-white group-hover:text-gray-100" aria-hidden="true" />
                            </span>
                            Sign up
                        </button>
                    </div>
